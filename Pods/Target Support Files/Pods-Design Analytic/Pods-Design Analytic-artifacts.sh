...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Smartlook/Smartlook.xcframework" "" "false" "ios-arm64_armv7/Smartlook.framework" "ios-arm64_i386_x86_64-simulator/Smartlook.framework"
fi
